...
public class DefineObjectsTag extends TagSupport {
	...
	static {
		try {
			JCR_NODE_CLASS = DefineObjectsTag.class.getClassLoader().loadClass(
					"javax.jcr.Node");
	...
	public int doEndTag() {
		...
		pageContext.setAttribute(resourceResolverName, scriptHelper
				.getRequest().getResourceResolver());
	...
	public void release() {
		...
		PageContextInitializationService pageContextInitalizationService = scriptHelper
				.getService(PageContextInitializationService.class);
		pageContextInitalizationService.initialize(pageContext, resource);
